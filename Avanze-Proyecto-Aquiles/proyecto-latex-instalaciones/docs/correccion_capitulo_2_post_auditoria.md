...
- `herramientas/calculos-electricos-vivienda/data/proyecto_aquiles_base.json`
- `herramientas/calculos-electricos-vivienda/scripts/calcular_instalacion.py`
- `herramientas/calculos-electricos-vivienda/output/resultados_aquiles.json`
- `herramientas/calculos-electricos-vivienda/output/tabla_areas.tex`
- `herramientas/calculos-electricos-vivienda/output/tabla_escenarios.tex`
- `herramientas/calculos-electricos-vivienda/output/tabla_cargas*.tex`
- `herramientas/calculos-electricos-vivienda/output/tabla_conductores*.tex`
- `herramientas/calculos-electricos-vivienda/output/reporte_calculos.md`
- `herramientas/calculos-electricos-vivienda/docs/notas_formulas.md`
- `Avanze-Proyecto-Aquiles/proyecto-latex-instalaciones/capitulos/01-memoria-descriptiva.tex`
- `Avanze-Proyecto-Aquiles/proyecto-latex-instalaciones/capitulos/02-calculos-justificativos.tex`
- `Avanze-Proyecto-Aquiles/proyecto-latex-instalaciones/capitulos/03-especificaciones-materiales.tex`
- `Avanze-Proyecto-Aquiles/proyecto-latex-instalaciones/capitulos/04-especificaciones-montaje.tex`
- `Avanze-Proyecto-Aquiles/proyecto-latex-instalaciones/main.tex`
- `Avanze-Proyecto-Aquiles/proyecto-latex-instalaciones/preambulo.tex`
- `Avanze-Proyecto-Aquiles/proyecto-latex-instalaciones/preguntas_para_calculos.md`
- `Avanze-Proyecto-Aquiles/proyecto-latex-instalaciones/docs/formulas_extraidas_capitulo_2.md`

## 4. Compilacion y revision visual

Comandos usados desde `Avanze-Proyecto-Aquiles/proyecto-latex-instalaciones/`:
...
`Avanze-Proyecto-Aquiles/proyecto-latex-instalaciones/build/main.pdf`

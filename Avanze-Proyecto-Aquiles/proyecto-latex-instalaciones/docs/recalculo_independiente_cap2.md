...
**Fecha:** 2026-06-03  
**Metodo:** recalcado independiente con lectura directa de `proyecto_aquiles_base.json` y comparacion contra `resultados_aquiles.json`. No se modifico el motor principal.

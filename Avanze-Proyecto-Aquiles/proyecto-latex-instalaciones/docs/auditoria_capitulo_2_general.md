...
- `Avanze-Proyecto-Aquiles/proyecto-latex-instalaciones/capitulos/02-calculos-justificativos.tex`: existe y esta incluido en `main.tex`.
- `Avanze-Proyecto-Aquiles/proyecto-latex-instalaciones/build/main.pdf`: existe y fue recompilado, 20 paginas, tamano carta.
- `Avanze-Proyecto-Aquiles/proyecto-latex-instalaciones/docs/auditoria_fuentes_calculo.md`: existe.
- `Avanze-Proyecto-Aquiles/proyecto-latex-instalaciones/docs/formulas_extraidas_capitulo_2.md`: existe.
- `Avanze-Proyecto-Aquiles/proyecto-latex-instalaciones/preguntas_para_calculos.md`: existe.
- `herramientas/calculos-electricos-vivienda/`: existe.
- `herramientas/calculos-electricos-vivienda/data/proyecto_aquiles_base.json`: existe.
- `herramientas/calculos-electricos-vivienda/scripts/calcular_instalacion.py`: existe.
- `herramientas/calculos-electricos-vivienda/output/`: existe y contiene `resultados_aquiles.json`, `tabla_cargas.tex`, `tabla_conductores.tex` y `reporte_calculos.md`.
...
- Eliminaciones locales en `Avanze-Proyecto-Aquiles/trabajo-cad-casa/salidas/croquis_aquiles_v*.dxf/pdf`.
...
- La ubicacion del motor Python es correcta: `herramientas/calculos-electricos-vivienda/`.
- La ubicacion del expediente LaTeX es correcta: `Avanze-Proyecto-Aquiles/proyecto-latex-instalaciones/`.
...
Archivo revisado: `herramientas/calculos-electricos-vivienda/scripts/calcular_instalacion.py`.

### Datos que lee

- Entrada fija: `data/proyecto_aquiles_base.json`.
- No acepta argumentos CLI para elegir otro JSON o carpeta de salida.
- Salida fija: `output/resultados_aquiles.json`, `output/tabla_cargas.tex`, `output/tabla_conductores.tex`, `output/reporte_calculos.md`.
...
El motor fue ejecutado desde `herramientas/calculos-electricos-vivienda/` con:
...
Archivo revisado: `herramientas/calculos-electricos-vivienda/data/proyecto_aquiles_base.json`.

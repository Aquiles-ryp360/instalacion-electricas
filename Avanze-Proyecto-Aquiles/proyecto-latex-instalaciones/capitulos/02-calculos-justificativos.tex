...
\input{../../herramientas/calculos-electricos-vivienda/output/tabla_areas.tex}
...
\input{../../herramientas/calculos-electricos-vivienda/output/tabla_escenarios.tex}
...
Donde \(N_j\) es la cantidad de elementos de la carga tipo \(j\) y \(P_j\) es la potencia nominal unitaria en watts. En el escenario sin cocina electrica de alta potencia se obtiene \(P_{inst}=8,918\text{ W}\). En el escenario con cocina electrica considerada se obtiene \(P_{inst}=11,518\text{ W}\).
...
\input{../../herramientas/calculos-electricos-vivienda/output/tabla_cargas.tex}
...
\input{../../herramientas/calculos-electricos-vivienda/output/tabla_conductores.tex}

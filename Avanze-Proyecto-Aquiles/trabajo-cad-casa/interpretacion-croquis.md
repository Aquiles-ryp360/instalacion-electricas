...
- La carpeta `herramientas/ia-cad-casas/` ya contenia el motor reutilizable: generador Python, script QCAD, lanzador shell, JSON de ejemplo y notas tecnicas.
- La carpeta `Avanze-Proyecto-Aquiles/trabajo-cad-casa/` ya contenia layouts y revisiones previas enfocadas en Piso 2.
- `proyecto-casa/07-planos/` no existe en este checkout.
- `latex/planos/` y `proyecto_vivienda_unifamiliar_por_RENZO/planos/` contienen referencias/finales previos; no se usaron como laboratorio.

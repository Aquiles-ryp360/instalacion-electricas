...
El expediente se organiza en los siguientes capitulos: memoria descriptiva,
calculos justificativos (incluida la verificacion normativa), memoria de
calculo de iluminacion, especificaciones tecnicas, ejecucion/seguridad y
cumplimiento normativo, cronograma, metrados y presupuesto, planos de
instalaciones electricas (IE-01..IE-06), planos base u originales y
conclusiones y recomendaciones. Las tablas y figuras se referencian en el
texto y el indice general recoge la numeracion de capitulos y secciones.

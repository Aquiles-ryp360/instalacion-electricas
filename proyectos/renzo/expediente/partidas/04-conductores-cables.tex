...
Conductor de cobre electrolitico recocido para circuitos de alumbrado C1, C4 y C6. Debe cumplir con NTP 370.252, NTP-IEC 60228 (Clases de conductores) y CNE-U Articulo 500.1.
...
\begin{enumerate}
  ...
  \item \textbf{Tendido:}
  \begin{enumerate}
    \item Introducir guia de alambre \#14 por la tuberia.
...
\midrule
Seccion & Calibrador Vernier sobre cobre pelado & 1.5 mm2 ± 2.5\% (diametro $\approx$ 1.38 mm) \\
...
Conductor de cobre LSOH 2.5 mm2 para circuitos de tomacorrientes C2, C3, C5 y C7. La seccion de 2.5 mm2 es la minima exigida por CNE-U para circuitos de tomacorrientes residenciales.
...
Para el circuito C5 (tomacorrientes segundo piso) con mayor carga: 1500 W instalados, 5.30 A de demanda, longitud maxima 30 m:

\begin{equation}
\Delta V = \frac{2 \times 30 \times 5.30 \times 0.0172}{2.5} = 2.18\%
\end{equation}

Se mantiene dentro del 2.5\% recomendado. Si la longitud real supera los 30 m, se debe volver a verificar en obra.
...
\textbf{Parametro} & \textbf{Metodo de verificacion} & \textbf{Criterio de aceptacion} \\
\midrule
Seccion & Calibrador Vernier & 2.5 mm2 ± 2.5\% (diametro $\approx$ 1.78 mm) \\
...
Demanda maxima: 30.81 A, alimentador: 10 mm2, longitud: 15 m desde medidor hasta TG-01.

\begin{equation}
\Delta V = \frac{2 \times 15 \times 30.81 \times 0.0172}{10} = 1.59\% < 2.5\% \text{ OK}
\end{equation}
...
\begin{itemize}
  \item Verificar seccion con calibrador (diametro $\approx$ 3.57 mm para 10 mm2).

...
Tuberia de policloruro de vinilo (PVC) tipo liviano para canalizacion electrica de los circuitos de alumbrado C1, C4 y C6. Debe cumplir con la NTP 399.006 (Tubos de PVC para instalaciones electricas) y la NTP-IEC 61386 (Sistemas de tubos para la gestion del cableado).
...
\begin{itemize}[nosep]
  ...
  \item Para 3 conductores de 1.5 mm2 (diametro exterior $\approx$ 3.5 mm), area ocupada: 3 x 9.6 mm2 = 28.8 mm2. Area interior de tuberia 3/4'': 213.8 mm2. Porcentaje de ocupacion: 13.5\% < 40\% OK.
\end{itemize}
...
Guia de alambre galvanizado \#14 & 50 m | Para paso de conductores despues de instalada la canalizacion \\
\bottomrule
\end{longtable}
...
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    \item Fijar con alambre \#16 amarrado a la malla de acero, o con abrazaderas tipo gancho cada 0.80 m como maximo.
  ...
  \end{enumerate}
  \item \textbf{Prueba de paso:} Antes del vaciado de concreto, pasar una guia de alambre \#14 a traves de cada tramo de tuberia para verificar que no existan obstrucciones, aplastamientos o pegamento obstruyendo la seccion interior.
...
Continuidad de canalizacion & Prueba de paso con guia \#14 & Paso libre sin obstrucciones \\
...
Tuberia de PVC tipo pesado para canalizacion de circuitos de tomacorrientes C2, C3, C5 y C7. Debe cumplir con NTP 399.006.
...
Para 3 conductores de 2.5 mm2 (diametro exterior $\approx$ 4.2 mm): area ocupada por conductor = 13.9 mm2. Area total 3 conductores = 41.6 mm2. Area interior de tuberia 3/4'' PV-P = 176.7 mm2. Porcentaje = 23.5\% < 40\% OK.
...
\begin{itemize}[nosep]
  ...
  \item \textbf{Ocupacion:} Para 3 conductores de 10 mm2 (diametro $\approx$ 6.5 mm): area ocupada total = 99.5 mm2. Area interior = 314.2 mm2. Porcentaje = 31.7\% < 40\% OK.
\end{itemize}

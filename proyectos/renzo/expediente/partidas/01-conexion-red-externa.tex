...
La demanda maxima del proyecto es 30.81 A. El conductor de 10 mm2 con aislamiento LSOH soporta hasta 52 A en tuberia empotrada (CNE-U Tabla 5.2 para 3 conductores cargados), lo que representa un margen suficiente frente a la demanda calculada y permite ampliaciones futuras sin reemplazar el alimentador.
...
\begin{enumerate}
  \item \textbf{Replanteo:} Coordinar con la empresa distribuidora (Electro Puno S.A.A.) la ubicacion del punto de acometida y las condiciones de suministro. Marcar en fachada la ubicacion de la caja portamedidor segun el diagrama IE-05, respetando:
  \begin{itemize}
  ...
  \begin{enumerate}
    \item Pasar guia de alambre galvanizado \#14 a traves de la tuberia.

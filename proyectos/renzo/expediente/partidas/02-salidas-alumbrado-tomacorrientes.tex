...
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    \item Fijar a la losa de techo mediante alambre \#16 amarrado a la armadura de acero, o mediante clavos de 2'' en encofrado de madera.
...
\begin{enumerate}
  \item \textbf{Replanteo:} Marcar en el muro la ubicacion del interruptor segun las laminas IE-02, IE-03 e IE-04. Verificar:
  \begin{itemize}
...
\begin{enumerate}
  \item \textbf{Replanteo:} Marcar la ubicacion segun la lamina del piso correspondiente (IE-02, IE-03 o IE-04) a las alturas especificadas. Verificar que no existan obstaculos (tuberias de agua, desague, gas).
...
Tomacorriente doble de servicio pesado 20 A -- 250 V, con contacto a tierra de mayor diametro (espiga de 5/16''), para cargas intensivas como lavadora, horno microondas o equipos de cocina de alta potencia. Debe cumplir con NTP-IEC 60884-1.

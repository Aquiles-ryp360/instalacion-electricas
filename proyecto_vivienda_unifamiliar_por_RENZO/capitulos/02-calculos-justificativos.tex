...
\begin{tabularx}{\textwidth}{L{1.0cm}L{2.2cm}r r r r Y}
\toprule
\textbf{Cto.} & \textbf{Uso} & \textbf{Pot. inst. W} & \textbf{Factor} & \textbf{Pot. dem. W} & \textbf{Corriente A} & \textbf{Observación} \\
\midrule
...
\begin{longtable}{c L{2.3cm} L{2.6cm} L{2.2cm} c r r L{1.0cm} L{2.4cm}}
...
\begin{tabularx}{\textwidth}{L{2.0cm}L{4.0cm}L{3.6cm}Y}
\toprule
...
\begin{tabularx}{\textwidth}{L{1.7cm}L{3.5cm}L{2.6cm}Y}
\toprule
...
\begin{tabularx}{\textwidth}{L{1.6cm}L{2.7cm}L{3.2cm}L{3.2cm}Y}
\toprule
...
\begin{tabularx}{\textwidth}{L{3.5cm}L{3.0cm}L{2.2cm}Y}
\toprule
...
\begin{tabularx}{\textwidth}{L{4cm}L{5cm}Y}
\toprule
...
\begin{tabularx}{\textwidth}{p{4.0cm}>{\raggedright\arraybackslash}X}
\toprule
\textbf{Componente} & \textbf{Especificacion académica} \\
\midrule

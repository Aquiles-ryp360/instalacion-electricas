...
folders = ["cuadro_cargas", "maxima_demanda", "metrados", "presupuesto"]
...
def generate_cuadro_cargas():
    ...
    wb.save(os.path.join(base_dir, "cuadro_cargas", "cuadro_cargas.xlsx"))
...
def generate_maxima_demanda():
    ...
    wb.save(os.path.join(base_dir, "maxima_demanda", "maxima_demanda.xlsx"))
...
def generate_metrados():
    ...
    wb.save(os.path.join(base_dir, "metrados", "metrados.xlsx"))
...
def generate_presupuesto():
    ...
    wb.save(os.path.join(base_dir, "presupuesto", "presupuesto.xlsx"))

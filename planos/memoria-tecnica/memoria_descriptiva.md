...
### 1. Generalidades
El presente documento constituye la **Memoria Descriptiva** para el diseño de las instalaciones eléctricas interiores de una vivienda unifamiliar de tres niveles. El predio se encuentra en zona urbana del distrito de Capachica, provincia y departamento de Puno. 

El diseño se ha elaborado bajo los lineamientos del **National Electrical Code (NEC)** y de la normativa local de referencia en Perú (CNE-U y Norma RNE EM.010), garantizando la seguridad, funcionalidad, flexibilidad y eficiencia del sistema.

### 2. Datos del Proyecto
* **Propietario:** Renzo Gabriel Mamani Galindo
* **Ubicación:** Jr. Lima S/N, Capachica, Puno (Coordenadas de referencia: 15°38'32.7"S 69°49'51.8"W)
* **Zona:** Urbana
...
* Distribuir de forma lógica los puntos de alumbrado, interruptores y tomacorrientes en cada ambiente.
* Estructurar el sistema mediante tableros eléctricos por piso para facilitar el mantenimiento y control local.
* Seleccionar calibres de conductores y capacidades de interruptores termomagnéticos y diferenciales de acuerdo con el NEC.
* Prever canalizaciones seguras empotradas en tuberías de PVC.
* Implementar un sistema de puesta a tierra (SPAT) para proteger la integridad de las personas y equipos.

---

### 4. Distribución Arquitectónica
La vivienda cuenta con las siguientes áreas y ambientes funcionales identificados en los planos arquitectónicos:

| Piso | Ambientes Principales | Circulaciones y Apoyos |
| :--- | :--- | :--- |
...
### 5. Sectorización y Circuitos Eléctricos
Para garantizar la continuidad del servicio y simplificar el mantenimiento, la vivienda se ha sectorizado en **7 circuitos derivados independientes** estructurados de la siguiente manera:

* **Piso 1:**
  * **Circuito C1 (Alumbrado):** Salidas de alumbrado en Tienda, Cocina, Pasadizo y Escalera.
  * **Circuito C2 (Tomacorrientes Generales):** Tomacorriente doble de la Tienda.
  * **Circuito C3 (Tomacorrientes Cocina):** Puntos de tomacorrientes específicos de la Cocina para artefactos electrodomésticos.
* **Piso 2:**
  * **Circuito C4 (Alumbrado):** Salidas de alumbrado en Dormitorio Principal, Dormitorio 3, Sala/Hall, Baño y Escalera.
  * **Circuito C5 (Tomacorrientes Generales):** Tomacorrientes en Dormitorios y Sala/Hall.
* **Piso 3:**
  * **Circuito C6 (Alumbrado):** Salidas de alumbrado en Dormitorio 4, Dormitorio 5, Pasadizo, Baño y Escalera.
  * **Circuito C7 (Tomacorrientes Generales):** Tomacorrientes y cajas de paso del tercer nivel.
...
* **Salidas de Alumbrado de Techo:** Centradas en los ambientes respectivos.

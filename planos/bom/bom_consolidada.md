...
### 1. Cuadro Consolidado de Materiales

#### 1.1. Canalizaciones y Conduits (PVC)
| Descripción | Diámetro | Unidad | Cantidad | Observación / Criterio |
| :--- | :---: | :---: | :---: | :--- |
| Tubería PVC-SEL (Eléctrica) | $3/4"$ | m | 149.0 | Distribución ramales de alumbrado y tomas |
| Tubería PVC-SAP (Pesado) | $1"$ | m | 8.0 | Acometida general de alimentación |
| Codos PVC $90^\circ$ | $3/4"$ | und | 62 | Curvas y bajadas en muros |
| Codos PVC $90^\circ$ | $1"$ | und | 4 | Curvas para el alimentador |
| Uniones a presión PVC | $3/4"$ | und | 46 | Empalme de tubos |
| Conectores tubo-caja PVC | $3/4"$ | und | 88 | Acoplamiento de tuberías a cajas |
| Conectores tubo-caja PVC | $1"$ | und | 6 | Acoplamiento de alimentación a TG-01 |

#### 1.2. Conductores Eléctricos (Cobre electrolítico)
| Uso / Circuito | Tipo | Calibre | Color | Unidad | Cantidad |
| :--- | :---: | :---: | :---: | :---: | :---: |
...
| :--- | :--- | :---: | :---: |
| **Tablero Principal (TG-01)** | Gabinete empotrado metal/PVC 12 polos | und | 1 |
| **Subtableros (TD-01, TD-02)** | Gabinete empotrado metal/PVC 8 polos | und | 2 |
| **ITM General (TG-01)** | Termomagnético 2P - 32A | und | 1 |
| **ITM Derivación / Cabecera** | Termomagnético 2P - 25A | und | 4 |
| **ITM Cocina (C3)** | Termomagnético 2P - 20A | und | 1 |
| **ITM Tomacorrientes (C2, C5, C7)**| Termomagnético 2P - 16A | und | 3 |
| **ITM Alumbrado (C1, C4, C6)** | Termomagnético 2P - 10A | und | 3 |
| **ID Principal (TG-01)** | Diferencial 2P - 40A / 30mA | und | 1 |
| **ID Circuitos (C2, C3, C5, C7)**| Diferencial 2P - 25A / 30mA | und | 4 |

...
La presente memoria descriptiva corresponde al mini proyecto de instalacion electrica interior de una vivienda ubicada en \editar{distrito, provincia y departamento}.
...
\textbf{Pendiente normativo:} \editar{agregar numerales especificos del CNE-U y EM.010 cuando el grupo revise las normas.}
...
\midrule
\endhead
Direccion o referencia & \editar{Completar direccion o referencia} \\
Distrito & \editar{Completar distrito} \\
Provincia & \editar{Completar provincia} \\
Departamento & \editar{Completar departamento} \\
Tipo de zona & \editar{Urbana, periurbana o rural} \\
\bottomrule
\end{longtable}
...
\midrule
\endhead
Tipo de vivienda & \editar{Unifamiliar, multifamiliar u otra} \\
Numero de pisos & \editar{Completar} \\
Area aproximada & \editar{Completar en m2} \\
Material predominante & \editar{Completar} \\
Numero de ambientes & \editar{Completar} \\
Tension de suministro & 220 V, 60 Hz, monofasico, salvo verificacion local \\
Tablero general & \editar{Ubicacion propuesta del tablero} \\
\bottomrule
\end{longtable}
...
\midrule
\endhead
1 & Sala & Alumbrado y tomacorrientes & \editar{Completar} \\
2 & Cocina & Alumbrado, tomacorrientes y posibles cargas especiales & \editar{Completar} \\
3 & Dormitorio 1 & Alumbrado y tomacorrientes & \editar{Completar} \\
4 & Bano & Alumbrado y tomacorriente protegido & \editar{Completar} \\
5 & Lavanderia & Tomacorriente y carga especial si aplica & \editar{Completar} \\
\bottomrule
\end{longtable}
...
\begin{itemize}
  \item Financiamiento: \editar{Completar}.
  \item Plazo estimado: \editar{Completar, por ejemplo 5 dias de trabajo}.
\end{itemize}

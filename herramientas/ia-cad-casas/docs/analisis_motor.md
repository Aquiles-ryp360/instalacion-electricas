# Análisis del Motor CAD: `ia-cad-casas`
...
El motor `ia-cad-casas` permite la conversión automática de una especificación abstracta de distribución arquitectónica (en formato JSON) a archivos CAD 2D vectoriales estándar (DXF y PDF).

...
DEFAULT_BOM = BASE_DIR / "bom.json"
DEFAULT_ADDITIONS = BASE_DIR / "data" / "metrados_adicionales_aquiles.json"
DEFAULT_OUTPUT = BASE_DIR / "bom_final_aquiles.json"
ELECTRICOS_DIR = REPO_DIR / "Avanze-Proyecto-Aquiles" / "trabajo-cad-casa" / "electricos"
FUENTES_DXF = [
    ELECTRICOS_DIR / "salidas" / "electrico_piso1_v7.dxf",
    ELECTRICOS_DIR / "salidas" / "electrico_piso2_v6.dxf",
]
FUENTES_JSON = [
    ELECTRICOS_DIR / "data" / "electrico_piso1_v6.json",
    ELECTRICOS_DIR / "data" / "electrico_piso2_v6.json",
]
...
def construir_bom_final(bom_path: Path, additions_path: Path) -> Dict[str, Any]:
    ...
    return {
        ...
        "nota_fuentes": (
            "Se adopta piso1_v7 por ser la revision DXF mas reciente. En piso 2 se adopta v6: "
            "el archivo v2 tiene una marca de modificacion posterior, pero corresponde a una revision funcional anterior "
            "y no contiene la red PE vigente."
        ),
        "resumen": {
